...
import client1 from '../assets/kiriloader.png';
...
const WheelLoader = () => {
  ...
  return (
    <div className="portfolio-page">
      ...
      <br /><br /><br />
      <h2 className="background-title2"><b>Wheel Loader</b></h2>
        ...
        <div className="portfolio-grid">
          {visiblePortfolios.map((item, index) => (
            <div className="portfolio-card portfolio-card-animate" key={index}>
                <div className="label-concrete-pump">Wheel Loader</div> {/* New Label */}
