...
import concretePump from '../assets/MiniPump.png'; 
...
import OverviewSectionMini from '../components/OverviewSectionMini';
        ...
        <div className="portfolio-page">
            ...
            <div className="profile-container d-flex">
                ...
                <div className="content-section" ref={textRef}>
                    ...
                    <h1 className="monster-name">MINI 17 M</h1>
            ...
            <br />
            <br />
            <div className="baru2"><OverviewSectionMini /></div>
            </div>
