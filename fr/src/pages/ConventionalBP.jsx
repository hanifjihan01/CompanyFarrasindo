...
import kiri_minilb from '../assets/bpnew.png';
...
import minisketch from '../assets/hzs120pd.png';
import OverviewSectionMoli from '../components/OverviewSectionMoli';
import OverviewSectionCBP from '../components/OverviewSectionCBP';

const ConventionalBP = () => {
            ...
            >
                ...
                <div className="profile-container d-flex">
                    ...
                    <div className="content-section" ref={textRef}>
                        ...
                        <h1 className="monster-name">MOUNTED LINE PUMP</h1>
                ...
                <div className="minisketch-container" data-aos="fade-in" data-aos-duration="1000">
                    <img src={minisketch} alt="Mini Sketch" className="minisketchbp-image" />
                </div>
                <br />
                <br />
                <div className="baru2"><OverviewSectionCBP /></div>
            </div>
