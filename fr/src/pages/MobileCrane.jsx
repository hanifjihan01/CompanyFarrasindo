...
import client7 from '../assets/crane55.png';
import client8 from '../assets/crane25.png';
...
const MobileCrane = () => {
  ...
  return (
    <div className="portfolio-page">
      ...
      <br /><br /><br />
      <h2 className="background-title2"><b>Mobile Crane</b></h2>
        ...
        <div className="portfolio-grid">
          {visiblePortfolios.map((item, index) => (
            ...
            <div className="portfolio-card portfolio-card-animate" key={index}>
              <div className="label-concrete-pump">Mobile Crane</div> {/* New Label */}
