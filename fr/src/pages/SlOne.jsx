...
import kiri_minilb from '../assets/slone.png';
...
import project from '../assets/slefloadingheader.png';
...
import minisketch from '../assets/slcmdimensi.png';
            ...
            >
                ...
                <div className="profile-container d-flex">
                    <div className="left-section">
                        <div className="side-label">Self Loading Mixer</div>
                    </div>
                    

                    <div className="content-section" ref={textRef}>
                        <div className="badge badge-agility">Self Loading Mixer</div>
                ...
                <div className="minisketch-container" data-aos="fade-in" data-aos-duration="1000">
                    <img src={minisketch} alt="Mini Sketch" className="minisketchslcm-image" />
                </div>
                <br />
                <br />
                <div className="baru2"><OverviewSectionMLB /></div>
            </div>
