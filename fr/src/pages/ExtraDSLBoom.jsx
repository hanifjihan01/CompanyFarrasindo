...
import concretePump from '../assets/ExtraDoubleSuperLongBoomPump.png'; 
...
import OverviewSectionEDSLBoom from '../components/OverviewSectionEDSLBoom';
import bgrigi from '../assets/bgrigi.png';
import ReactPlayer from 'react-player/lazy';
import minisketch from '../assets/dimensiedsl.png';
        ...
        <div className="portfolio-page">
            ...
            <div className="profile-container d-flex">
                ...
                <div className="content-section" ref={textRef}>
                    ...
                    <h1 className="monster-name">EXTRA DOUBLE SUPER LONG BOOM 60 M</h1>
            ...
            <div className="minisketch-container" data-aos="fade-in" data-aos-duration="1000">
                    <img src={minisketch} alt="Mini Sketch" className="minisketch5-image" />
                </div>
            <br />
            <div className="baru2"><OverviewSectionEDSLBoom /></div>
            </div>
