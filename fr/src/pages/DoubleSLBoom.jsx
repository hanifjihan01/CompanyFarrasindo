...
import concretePump from '../assets/DoubleSuperLongBoomPump.png'; 
...
import OverviewSectionDSLBoom from '../components/OverviewSectionDSL';
import bgrigi from '../assets/bgrigi.png';
import ReactPlayer from 'react-player/lazy';
import minisketch from "../assets/dimensidsl.png";
        ...
        <div className="portfolio-page">
            ...
            <div className="profile-container d-flex">
                ...
                <div className="content-section" ref={textRef}>
                    ...
                    <h1 className="monster-name">DOUBLE SUPER LONG BOOM 40 M</h1>
            ...
            <div className="minisketch-container" data-aos="fade-in" data-aos-duration="1000">
                    <img src={minisketch} alt="Mini Sketch" className="minisketch3-image" />
                </div>
            <br />
            <div className="baru2"><OverviewSectionDSLBoom /></div>
            </div>
