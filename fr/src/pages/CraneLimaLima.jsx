...
import kiri_minilb from '../assets/crane55.png';
            ...
            >
                ...
                <div className="profile-container d-flex">
                    <div className="left-section">
                        <div className="side-label">MOBILE CRANE</div>
                    </div>
                  
                    <div className="content-section" ref={textRef}>
                        <div className="badge badge-agility">MOBILE CRANE</div>
                        <h1 className="monster-name">CRANE 55</h1>
