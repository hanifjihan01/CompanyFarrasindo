...
import client4 from '../assets/sltwo.png';
...
import client8 from '../assets/slone.png';
...
const SelfLoading = () => {
  ...
  return (
    <div className="portfolio-page">
      ...
      <br /><br /><br />
      <h2 className="background-title2"><b>Self Loading Mixer</b></h2>
        ...
        <div className="portfolio-grid">
          {visiblePortfolios.map((item, index) => (
            ...
            <div className="portfolio-card portfolio-card-animate" key={index}>
              <div className="label-concrete-pump">Self Loading Mixer</div> {/* New Label */}
