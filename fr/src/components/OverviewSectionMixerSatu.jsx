...
import '../index.css'; 
import carImage from '../assets/tm1new.png'; 

const OverviewSectionMixerSatu = () => {
  return (
      ...
      <div className="containerOverview">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-right">
            <img src={carImage} alt="Truck" className="car-imagemixersatu" />
          </div>
        </div>
      </div>
    </div>
...
export default OverviewSectionMixerSatu;
